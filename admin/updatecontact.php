    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <?php
                ...
                $id= get_safe_value($conn,$_GET['id']);
                $query = "SELECT * FROM contactpage where id ='$id'";
        ...
        <form action="editcontact.php" method="POST" > 
                    <div class="popup col-md-8 col-xl-10"" id="popup-1">
                        <div class="content container">
                                        ...
                                        <BR>
                                        <div>
                                            <input type="hidden" placeholder="id..."  name="id" value="<?php echo $row['id']?>" required>  
                                            <input style="padding:5px; margin:2px" type="text" placeholder="location..."  name="location" value="<?php echo $row['location']?>" required> 
                                            <br>    
                                            <input  style="padding:5px; margin:2px" type="email" placeholder="Email"  name="email" value="<?php echo $row['email']?>" required> 
                                            <br>  
                                            <input  style="padding:5px; margin:2px" type="tel" placeholder="Phone No."  name="phone" value="<?php echo $row['phone']?>" required>        
            ...
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Update Contact Information</h1>
