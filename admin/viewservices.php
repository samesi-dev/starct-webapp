        ...
        <form action="editservice.php" method="POST" > 
                    <div class="popup col-md-8 col-xl-10"" id="popup-1">
                        <div class="content container">
                                        ...
                                        <BR>
                                        <div>
                                            <input type="hidden" placeholder="Service Id..."  name="cat_id" value="<?php echo $row['cat_id']?>" required>   
                                            <input type="text" placeholder="Service Name..."  name="cat_name" value="<?php echo $row['cat_name']?>" required>   
            ...
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Update Service Information</h1>
                        ...
                        ?>
                               <tr>
                                ...
                                <td> <a><button onclick="togglePopup()" class="btn btn-primary"> <span>Edit</span></button></a>
                                    ...
                                    <a href="deleteservice.php?cat_id=<?php echo $row['cat_id']?>"> <button type="submit" class="btn btn-secondary"> <span>Del</span></button></a>   
                                </td>
