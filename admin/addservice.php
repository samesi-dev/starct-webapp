...
if(isset($_POST['insert-cat']))
{
    ...
    {
        $_SESSION['status1'] = "ID Already Taken. Please Try Another one.";
    ...
    else
    {
        ...
        (cat_id,cat_name,description)
         VALUES ('$cat_id','$cat_name','$description')";
                $query_run = mysqli_query($conn, $query);
             if ($query_run)
              {
             // echo "Saved";
...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">Add Service Details</h1>
            ...
            <div class="col-md-8 col-xl-10">
                ...
                <div class="card-header">
                        ...
                        <div>
                        <p > <label style="float: left; padding:5px">Service No.</label></p> 
                        <p style="margin-left: 20%;" > <input type="text" placeholder="Service No...."  name="cat_id" required></p>
                            <p > <label style="float: left; padding:5px">Service Name</label></p>  
                            <p style="margin-left: 20%;" > <input type="text" placeholder="Service Name..."  name="cat_name" required></p>    
                            <p style="float: left; padding:5px" > <label >Description</label></p>  
                            <p style=" float:left;margin-left:8%">   <textarea  placeholder="Description " name="description" rows="2" cols="23"></textarea></p>
                            <a><button type="submit" name="insert-cat" style="margin-left:85%" class="btn btn-primary"><i class="align-middle" data-feather="plus-square"></i> <span>Submit</button></a>  </span>      
                            </div>
                            </div>
