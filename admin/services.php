    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Services List</h1>
                    <div class="mb-3">
					
                        <a href="addservice.php" ><button  style="margin-left:80%" class="btn btn-primary">   <i class="align-middle" data-feather="user-plus"></i> <span>Add Service</span></button></a>
					</div>
  ...
  <tbody>
                        ...
                        ?>
                               <tr>
                                ...
                                <td> <a href="viewservices.php?cat_id=<?php echo $row['cat_id']?>"><button class="btn btn-primary"> <span>Details</span></button></a>
