    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Employee Lists</h1>
                    <div class="mb-3">
					
                        <a href="AddEmployeeInfo.php" ><button  style="margin-left:80%" class="btn btn-primary">   <i class="align-middle" data-feather="user-plus"></i> <span>Add Employee</span></button></a>
					</div>
                        ...
                        <?php
                $query = "SELECT * FROM tbl_employeedata";
  ...
  <tbody>
                        ...
                        ?>
                               <tr>
                                ...
                                <td> <a href="ViewEmployee.php?id=<?php echo $row['id']?>"><button  class="btn btn-primary"> <span>Details</span></button></a>
                                    
                                
                                     <a href="delete.php?id=<?php echo $row['id']?>"> <button  class="btn btn-secondary"> <span>Del</span></button></a>   
                                </td>
                                </tr>
                              <?php 
                            } 
